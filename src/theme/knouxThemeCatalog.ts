...
export const KNOUX_THEME_CATALOG: readonly KnouxThemePreset[] = [
  ...
  },
  {
    ...
    labelAr: 'كنوكس النهاري',
    description: 'Pearl-white daylight surfaces with crystal violet accents and graphite typography.',
    descriptionAr: 'أسطح نهارية لؤلؤية بلمسات بنفسجية كريستالية وكتابة جرافيت واضحة.',
    accent: '#7828e8',
