...
import type { AIImageProvenance, ImageLayer, ImageTask, ImageBlendMode, ImageTransform, LayerMask, RetouchDocumentState } from '../../src/core/image-studio/document/schema';
...
export interface InvokeArgumentMap {
  ...
  'image-studio:sync-retouch': [updates: Array<{ layerId: string; retouche: RetouchDocumentState | null }>];
  'image-studio:recent': [];
