...
- Version 2 project settings persist timeline zoom, while version 1 projects and autosaves migrate automatically on read.
...
- Windows workflow run `30615732971` passed TypeScript, zero-warning ESLint, all 10 Jest suites / 43 tests, Electron packaging, Squirrel make, packaged launch, Open With, single-instance forwarding, and cleanup on commit `427aeae77f3277f365cfe36ff2df6f3a16272e3c`.
...
- Add a user-facing malformed-autosave quarantine/recovery path.
